...
- Preview and local QuickBooks use Intuit **Development** keys plus `QBO_USE_SANDBOX=true` on edge; production (`main`) uses Production keys without the sandbox flag. Reconnect QB on preview after switching from production tokens.
