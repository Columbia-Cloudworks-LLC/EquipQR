...
/**
 * Example exemptions configuration:
 * 
 * {
 *   "exemptedUrls": [
 *     "https://example.com/requires-auth",
 *     "https://internal.company.com/*",
 *     "https://api.service.com/v1/docs"
 *   ],
 *   "exemptedDomains": [
 *     "localhost",
 *     "127.0.0.1",
 ...
 *   ],
 *   "exemptionReasons": {
 *     "https://example.com/requires-auth": "Authentication required - validated manually",
 *     "internal.company.com": "Internal domain - not accessible from CI environment",
 *     "api.service.com": "Rate limiting prevents automated checking"
 *   }
 * }
 */
