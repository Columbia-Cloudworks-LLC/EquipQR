 ...
 * description: Complete reference for EquipQR database tables and relationships
 * status: complete
 * type: architecture
 * tags: [database, schema, RLS]
...
/**
 * Example frontmatter for WIP document:
 * 
 * ---
 * title: New Feature Specification (DRAFT)
 * wip: true
 * type: feature
 * ---
 */
