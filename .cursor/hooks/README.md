...
- `markdown-lint-on-edit.ps1` - Runs markdownlint-cli2 on edited `.md`/`.mdc` files and blocks the agent until lint is clean (shared config: `.markdownlint-cli2.jsonc`, same engine as the markdownlint VS Code extension)
