...
- Never use triple backticks inside the generated plan. Nested code, schemas, JSON, SQL, and commands must be free text indented with exactly two or four spaces.
