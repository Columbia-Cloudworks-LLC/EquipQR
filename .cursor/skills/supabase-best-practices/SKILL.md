...
description: Supabase security and performance optimization guidelines. Contains 40+ rules across 10 categories covering RLS policies, database security, API security, storage, realtime, edge functions, and testing. Use when writing RLS policies, designing schemas, configuring storage buckets, writing edge functions, or reviewing Supabase code for security issues.
