...
- Multi-tenancy: Filter by `organization_id`, add RLS policies
- Type safety: Define TypeScript interfaces, no `any` types
- Architecture: Place components correctly (pages/features/ui)
...
**EquipQR-specific foundation tasks (if applicable):**
- [ ] TXXX Add RLS policies for new tables (filter by `organization_id`)
- [ ] TXXX [P] Define TypeScript interfaces in `src/types/`
- [ ] TXXX [P] Create Zod validation schemas for input data
