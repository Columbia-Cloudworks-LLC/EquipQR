...
COMMENT ON TABLE public.record_export_artifacts IS
  'Tracks the most recent exported document per record, enabling replace-on-re-export and quick Open last doc access. Schema supports any record type; v1 covers work orders.';
