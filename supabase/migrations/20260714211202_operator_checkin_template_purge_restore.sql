...
REVOKE ALL ON FUNCTION public.delete_operator_checklist_template(uuid) FROM authenticated;
...
REVOKE ALL ON FUNCTION public.restore_operator_checklist_template(uuid) FROM authenticated;
