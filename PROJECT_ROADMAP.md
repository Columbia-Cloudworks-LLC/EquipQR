...
- `#558` Node.js 24 runtime and toolchain alignment — `package.json` `engines.node` is **24.x** (Vercel-supported); CI and setup docs use Node **24.x**. Dev dependency `@types/node` may track a newer major for typings.
