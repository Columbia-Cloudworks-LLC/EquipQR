...
if (__ANIMATION_DEBUG__ && isAnimationDebugHost(location.hostname) && location.pathname === '/debug/animation-test' && new URLSearchParams(location.search).has('stage')) {
  void import('@/features/animation-debug/mountStage').then(({ mountStage }) => mountStage());
} else {
