...
const AssetQRCodePanel: React.FC<AssetQRCodePanelProps> = ({
  ...
  return (
    <div className={`${isMobile ? 'space-y-4' : 'space-y-6'}`}>
      ...
      >
        <CollapsibleTrigger className="flex w-full items-center justify-between gap-2 p-3 text-left font-medium text-foreground rounded-lg transition-colors motion-reduce:transition-none hover:bg-muted/80 group">
          How to use
          <ChevronRight
