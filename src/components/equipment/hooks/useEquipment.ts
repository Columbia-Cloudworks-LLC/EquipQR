...
import { EquipmentService, Equipment, EquipmentFilters, EquipmentCreateData, EquipmentUpdateData, EquipmentNote, EquipmentScan, EquipmentWorkOrder } from '@/services/EquipmentService';
