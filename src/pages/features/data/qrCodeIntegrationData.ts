...
export const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      "Use your phone camera or the in-app QR scanner to scan any label. You are redirected directly to that equipment's or item's page. Public links skip login when you configure them that way.",
  },
  {
    number: 3,
