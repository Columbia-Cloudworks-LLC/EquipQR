            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground">
                  Part Lookup & Alternates
                </h1>
              </div>

              <p className="text-xl sm:text-2xl text-muted-foreground mb-8 max-w-3xl">
                Quickly find parts by part number and discover interchangeable alternatives. Search inventory, external
                catalogs, and alternate part groups—all in one place.
              </p>

              <Button asChild size="lg" className="text-lg px-8 py-6">
                <Link to="/auth?tab=signup">
                  Start Using Part Lookup Free
