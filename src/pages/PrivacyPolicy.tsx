        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <p>
              ...
              of 2018 and the California Privacy Rights Act of 2020 (together,
              &quot;CCPA/CPRA&quot;).
            </p>
            ...
            <div className="overflow-x-auto">
              <table>
                ...
                <tbody>
                  <tr>
                    <td className="font-medium">Identifiers</td>
                    <td>Name, email address, account ID</td>
                    <td>Yes</td>
                  </tr>
                  <tr>
                    <td className="font-medium">Internet or Network Activity</td>
                    <td>Browser push subscription tokens, user agent</td>
                    <td>Yes</td>
                  </tr>
                  <tr>
                    <td className="font-medium">Geolocation Data</td>
                    <td>GPS coordinates from QR code scans (when enabled by org admin)</td>
                    <td>Yes (opt-in)</td>
                  </tr>
                  <tr>
                    <td className="font-medium">Professional or Employment Info</td>
                    <td>Organization membership, role, team assignments</td>
                    <td>Yes</td>
                  </tr>
                  <tr>
                    <td className="font-medium">Commercial Information</td>
                    <td>Work order and invoice data (via QuickBooks integration, when activated)</td>
                    <td>Conditional</td>
                  </tr>
                  <tr>
                    <td className="font-medium">Inferences / Activity Records</td>
                    <td>Audit trail entries, scan history, notification records</td>
                    <td>Yes</td>
                  </tr>
                </tbody>
              </table>
            ...
            <p>
              We collect two categories of information that qualify as Sensitive Personal
              Information under CPRA:
            </p>
            <ul>
              <li>
                <strong>Precise geolocation:</strong> GPS coordinates captured during QR code
                scans, only when an organization administrator has explicitly enabled location
                collection. This feature is off by default.
              </li>
              <li>
                <strong>Account login credentials:</strong> Email and password managed by our
                authentication provider (Supabase Auth). Passwords are cryptographically
            ...
            <ul>
              <li>
                <strong>Directly from you:</strong> Account registration, profile updates, QR
                code scans, bug reports, and notification preferences.
              </li>
              <li>
                <strong>From your organization:</strong> When an organization administrator
                connects Google Workspace, directory user data (names, emails) may be synced
                into EquipQR.
              </li>
              <li>
                <strong>Automatically:</strong> Browser push subscription endpoints, session
                tokens, and (when enabled) GPS coordinates.
              </li>
            </ul>

            <h3>Business Purposes</h3>
            <p>
              We use each category of personal information for the specific business purposes
              described in Section 6 of this Privacy Policy, including: providing the Service,
              authentication and access control, notifications, integration fulfillment,
              compliance and audit, and security and abuse prevention.
            </p>
            ...
            <div className="overflow-x-auto">
              <table>
                ...
                <tbody>
                  <tr>
                    <td>User profiles</td>
                    <td>Account lifetime plus 30 days post-deletion</td>
                  </tr>
                  <tr>
                    <td>Audit log entries</td>
                    <td>3 years (general) / 7 years (financial records)</td>
                  </tr>
                  <tr>
                    <td>QR scan records and location history</td>
                    <td>3 years from record date</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>Push notification subscriptions</td>
                    <td>90 days of inactivity</td>
                  </tr>
                  <tr>
                    <td>Organization invitations (expired/declined)</td>
                    <td>30 days after expiry</td>
                  </tr>
                  <tr>
                    <td>User departure records</td>
                    <td>90 days after processing</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p>
              Authenticated users can also submit requests directly from their account
              settings.
            </p>

            <h3>Verification</h3>
            <p>
              We will verify your identity before fulfilling a request. For authenticated
              users, your active session serves as verification. For unauthenticated
              requests, we will send a verification email to the address on file.
            </p>

            <h3>Authorized Agents</h3>
            <p>
              You may designate an authorized agent to submit requests on your behalf. The
              agent must provide written authorization signed by you, and we may contact you
