...
const EquipmentSortHeader: React.FC<EquipmentSortHeaderProps> = ({
  ...
  return (
    <div className={`${isMobile ? 'flex items-center justify-between gap-2' : 'flex items-center justify-between'} mb-4 md:mb-6`}>
      ...
      <div className="flex items-center gap-2">
        <Select value={compositeValue} onValueChange={handleCompositeChange}>
          <SelectTrigger
            className={isMobile ? 'h-9 w-auto min-w-[140px] gap-1 shrink-0' : 'w-[200px]'}
