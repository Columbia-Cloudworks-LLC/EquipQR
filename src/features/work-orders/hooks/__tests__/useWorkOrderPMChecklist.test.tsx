...
// Mock dependencies
vi.mock('../usePMTemplates');
vi.mock('../useSimplifiedOrganizationRestrictions');
...
describe('useWorkOrderPMChecklist', () => {
  beforeEach(async () => {
    ...
    const { useSimplifiedOrganizationRestrictions } = await import('../useSimplifiedOrganizationRestrictions');
