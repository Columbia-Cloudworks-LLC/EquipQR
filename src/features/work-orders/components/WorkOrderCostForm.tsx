...
import { useCreateWorkOrderCost, useUpdateWorkOrderCost } from '@/features/work-orders/hooks/useWorkOrderCosts';
                  ...
                  <FormControl>
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        // Parse the value, allowing NaN for invalid inputs
                        // Zod will validate the final value
