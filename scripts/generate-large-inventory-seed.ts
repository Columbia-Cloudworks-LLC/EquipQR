...
function generateSQL(): string {
  ...
  lines.push(`--`);
  lines.push(`-- IMPORTANT: Requires base seed data (organizations and users) to exist.`);
  lines.push(`-- Run core seed files before this one to avoid foreign key errors.`);
  lines.push(`--`);
