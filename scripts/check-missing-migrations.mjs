...
// Remote migrations from production (from mcp_supabase_list_migrations)
...
// Migration names mapping (from remote list)
...
function checkMissingMigrations() {
  ...
  const missing = remoteMigrations.filter(version => !localFiles.includes(version));
