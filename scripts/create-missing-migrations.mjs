...
function createMissingMigrations() {
  ...
  console.log(`📊 Expected migrations (from main): ${mainBranchMigrations.length}`);
  console.log(`📊 Local migrations: ${localFiles.length}\n`);

  // Find missing migrations
  const missing = mainBranchMigrations.filter(m => !localFiles.includes(m.version));
