...
test.describe('PR evidence right to repair stance @pr-evidence', () => {
  test('hero, filterable atlas, and case sheet on /right-to-repair', async ({ page }) => {
    ...
    await evidenceScreenshot(page, '01-right-to-repair-hero', { target: heading });
    ...
    await evidenceScreenshot(page, '02-right-to-repair-filtered-atlas', { target: farmCase });
    ...
    await evidencePause(page, 400);
    await evidenceScreenshot(page, '03-right-to-repair-case-sheet', { target: sheetTitle });
  });
  ...
  test('landing footer Legal column links to the stance page', async ({ page }) => {
    ...
    await evidencePause(page, 300);
    await evidenceScreenshot(page, '04-landing-footer-right-to-repair', { target: stanceLink });
