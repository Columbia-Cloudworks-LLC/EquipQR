...
- **Mobile Start work follows unassign state (#1481)** — On phone-width work order details, Next step now keeps Start work visible but disabled with assignee guidance when an accepted or assigned work order has no assignee.
